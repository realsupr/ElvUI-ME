...
DB["media"] = {
	...
	["dmgfont"] = "ElvUI Alt-Combat-2", -- general font of dmg / sct
...
DB["skin"] = {
	...
	["hookdxeright"] = false,
	["embedright"] = "OmenRecount",				-- Addon to embed to the right frame ("Omen", "Recount", "Skada")
...
DB["unitframes"] = {
	...
	["smallwidth"] = 115,					--Width of TargetTarget, Focus, FocusTarget, Player's Pet frames
	["smallheight"] = 37,					--Height of TargetTarget, Focus, FocusTarget, Player's Pet frames
	...
	["playeraurasperrow"] = 10,				-- buffs/debuffs per row on player/target frames
	["targetaurasperrow"] = 10,
...
DB["raidframes"] = {
	...
	["partypets"] = false,					-- enable party pets for the healer layout
...
DB["actionbar"] = {
	...
	["swaptopbottombar"] = true,			--swap the main actionbar position with the bottom actionbar
...
DB["datatext"] = {
	["stat1"] = 3,						   -- Stat Based on your Role (Avoidance-Tank, AP-Melee, SP/HP-Caster)
	["dur"] = 2,                           -- show your equipment durability on panels.
	["stat2"] = 0, 						   -- Stat Based on your Role (Armor-Tank, Crit-Melee, Crit-Caster)
	["system"] = 9,                        -- show fps and ms on panels, and total addon memory in tooltip
	["wowtime"] = 5,                       -- show time on panels
	["gold"] = 6,                          -- show your current gold on panels
	["guild"] = 8,                         -- show number on guildmate connected on panels
	["friends"] = 7,                       -- show number of friends connected.
	["calltoarms"] = 1,
	["bags"] = 4,							-- show ammount of bag space available
...
DB["chat"] = {
	...
	["chatfontscale"] = 11,					-- Add Custom by meat
	["chatwidth"] = 330,					-- width of chat frame
	["chatheight"] = 114,					-- height of chat frame
...
DB["tooltip"] = {
	...
	["cursor"] = true,                    -- show anchored to cursor
